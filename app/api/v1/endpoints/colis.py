...
from app.schemas.colis_schemas import ColisCreate, ColisBase ,  ColisResponse , ColisSimpleResponse , ColisUpdateStatus , ColisFilter
from app.controllers.colis_controller import ColisController
from typing import List
from app.api.deps import get_current_user   , get_current_active_client
...
@router.post("/")
def create_colis(colis: ColisCreate   ,  current_user: User = Depends(get_current_active_client)):
...
def update_status(
    ...
    controller = ColisController()
    # new_func(update_data, current_user) 
...
def new_func(update_data, current_user):
...
def read_all_colis(filters: ColisFilter = Depends(get_current_user) ):
    controller = ColisController()
